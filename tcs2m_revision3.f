     ...
     +              mdend_vq, ittst, ittbl, 
     +              mditt, mdittal, nclass )
            implicit none

            real(8), dimension(:)   :: adx     ! adx(iend)
            real(8), dimension(:,:) :: vq      ! vq(mdend,itt)
            real(8), dimension(:,:) :: tempc3a
...
!     print *,' totaltime ', real(count2-count0) / real(count_rate)
     ...
     +    mditt, mdittal, nclass )
      ...
      real(8), dimension(:)   :: adx   ! adx(mdend)
      real(8), dimension(:,:) :: vq    ! vq(mdend_vq,itt)
      real(8), dimension(:,:) :: tempc3a ! tempc3a(mdittal,nclass)
